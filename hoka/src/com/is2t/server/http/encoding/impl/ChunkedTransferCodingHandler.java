 ...
 * IS2T-API
 * <p>
 * HTTP-1.1 chunked transfer encoding handler to read and write data in chunked
 * encoding.<br>
 * </p>
 */
public class ChunkedTransferCodingHandler implements IHTTPTransferCodingHandler {
	 ...
	 */
	public String getId() {
		return "chunked"; // $NON-NLS
	}

	/**
	 * IS2T-API
	 * <p>
	 * Creates a {@link ChunkedMessageBodyInputStream} to read the body of the
	 * HTTP request in "chunked" encoding from the {@link HTTPRequest} and the
	 * {@link InputStream}.
	 * </p>
	 * 
	 * @param request
	 ...
	 * IS2T-API
	 * <p>
	 * Creates an {@link OutputStream} to write the body of the HTTP response in
	 * "chunked" encoding using the {@link HTTPResponse} and the
	 * {@link OutputStream}.
	 * </p>
	 * 
	 * @param response
